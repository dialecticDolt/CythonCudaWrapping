 ...
 */
  ...
  __pyx_t_11 = 0;
  __pyx_t_12 = 0;
  addition((&(*((float *) ( /* dim=0 */ (__pyx_v_c_out.data + __pyx_t_10 * __pyx_v_c_out.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_c_a.data + __pyx_t_11 * __pyx_v_c_a.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_c_b.data + __pyx_t_12 * __pyx_v_c_b.strides[0]) )))), __pyx_v_N);
